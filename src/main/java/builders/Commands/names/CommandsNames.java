...
public final class CommandsNames {
    ...
    public final static String bossCommand = "addboss";
    ...
    public static List<String> getCommands() {
        return Arrays.asList(worldCommand, bossCommand, serverStatusCommand, tibiaCoinsCommand, killingStatsCommand, houseCommand, eventsCommand);
    }
}
